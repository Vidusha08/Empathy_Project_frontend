...
export default function RegistrationPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    ageGroup: "16–18 years", gender: "Prefer not to say", agreeToTerms: false,
  });
  ...
  const validate = () => {
    ...
    if (!USERNAME_PATTERN.test(formData.username))
      e.username = "3-30 characters: lowercase letters, numbers, underscores only";
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (!validate()) return;
    // useAuth.register() handles the API call and navigation on success
    // (ageGroup, gender, and agreeToTerms stay local — authApi.registerUser
    // only forwards name/username/email/password to the backend).
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="text" name="fullName" value={formData.fullName} onChange={handleChange}
                  placeholder="Enter your first name & last name" className={inputCls(errors.fullName)} />
              </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="text" name="username" value={formData.username} onChange={handleChange}
                  placeholder="e.g. jane_doe22" className={inputCls(errors.username)} />
              </div>
              {errors.username ? (
                <InputError msg={errors.username} />
              ) : (
                <p className="text-xs text-gray-400 mt-1">This is what you'll use to log in.</p>
              )}
            </div>
